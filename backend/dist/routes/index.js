...
const paymentConfig_1 = __importDefault(require("./paymentConfig"));
const adminPagos_1 = __importDefault(require("./adminPagos"));
...
router.use('/payment-config', paymentConfig_1.default);
router.use('/admin/pagos', adminPagos_1.default);
